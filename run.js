...
const clscommand = document.querySelector(".clear");
...
function addItem() {
    ...
    if (textEnterd.length < 1) {
      ...
      <div class="p-date">
        ...
        clscommand.classList.add("clear-appear");
        textInput.value = "";

        let okdelete = liElement.querySelector(".delete");
        let itsdone = liElement.querySelector(".done");
        ...
        okdelete.addEventListener(
            "click",
            function() {
                liElement.outerHTML = "";
                if (!ulElement.innerText) {
                    clscommand.classList.remove("clear-appear");
                }
            },
            false
        );
        itsdone.addEventListener(
            "click",
            function() {
